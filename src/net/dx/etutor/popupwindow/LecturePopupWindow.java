...
public class LecturePopupWindow extends BasePopupWindow implements
	...
	public LecturePopupWindow(Context context, int type) {
	...
	public void initViews() {
		...
		arrys = new String[] { "不限", "学生上门", "家教上门", "附近公共场所" };
