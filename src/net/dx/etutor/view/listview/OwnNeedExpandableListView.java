 ...
 * @author yuanjiugang
 */
public class OwnNeedExpandableListView extends ExpandableListView {
	...
	public OwnNeedExpandableListView(Context context) {
		this(context, null);
	}

	public OwnNeedExpandableListView(Context context, AttributeSet attrs) {
