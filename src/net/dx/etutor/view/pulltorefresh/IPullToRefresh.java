...
import net.dx.etutor.view.pulltorefresh.PullToRefreshBase.OnPullEventListener;
import net.dx.etutor.view.pulltorefresh.PullToRefreshBase.OnRefreshListener;
import net.dx.etutor.view.pulltorefresh.PullToRefreshBase.OnRefreshListener2;
import net.dx.etutor.view.pulltorefresh.PullToRefreshBase.State;
