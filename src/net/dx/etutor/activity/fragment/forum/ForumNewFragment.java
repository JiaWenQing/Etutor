...
public class ForumNewFragment extends BaseFragment implements OnClickListener,
		OnRefreshListener<ListView> {
	/**
	 * 友盟统计
	 */
	protected boolean isCreated = false;
	public static String TAG = "ForumNewFragment";
	...
	public ForumNewFragment(EtutorApplication application, Activity activity,
