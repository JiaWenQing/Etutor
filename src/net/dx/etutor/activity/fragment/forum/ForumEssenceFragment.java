...
public class ForumEssenceFragment extends BaseFragment implements
	...
	public static String TAG = "ForumEssenceFragment";
	...
	public ForumEssenceFragment() {
		super();
	}

	public ForumEssenceFragment(EtutorApplication application,
			Activity activity, Context context, DxForumBoard mDxForumBoard) {
	...
	protected void initViews() {
		...
		// mImageView = (ImageView) findViewById(R.id.tv_not_info_school);
