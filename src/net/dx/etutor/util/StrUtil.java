...
public class StrUtil {
	...
	public static String passwrodMaker(String telephone, String password) {
		return Md5Util.md5(password + "deshell" + telephone);
	}
	 ...
	 * @return
	 */
	public static Integer getCoachTime(String coachTime) {
		Integer value = 1;
		if (coachTime.equals("10年以上")) {
			value = 11;
		} else if (coachTime.equals("不足1年")) {
			value = 0;
		} else {
			value = Integer.parseInt(coachTime.substring(0,
					coachTime.lastIndexOf("年")));
		}
		return value;
	}
	 ...
	 * @return
	 */
	public static String setCoachTime(Integer coachTime) {
		String value = "1年";
		if (coachTime >= 11) {
			value = "10年以上";
		} else if (coachTime == 0) {
